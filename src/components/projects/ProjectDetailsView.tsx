...
const mockTasks = [
    { id: 1, name: "Design Review", worker: "Piotr Wiśniewski", status: "Aktywny", hours: 40 },
    { id: 2, name: "Backend development", worker: "Jan Kowalski", status: "W toku", hours: 150 },
    { id: 3, name: "Frontend development", worker: "Marek Lewandowski", status: "Zakończony", hours: 250 },
    { id: 4, name: "Final Testing", worker: "Katarzyna Wójcik", status: "Zakończony", hours: 80 },
];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 space-y-6">
                    <div className="bg-white/50 rounded-lg shadow p-6">
                        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Zadania</h2>
                        <div className="overflow-x-auto">
                            <table className="w-full text-left">
                                <thead className="border-b-2 border-gray-200">
                                <tr>
                                    <th className="p-3 font-semibold text-gray-600">Nazwa</th>
                                    <th className="p-3 font-semibold text-gray-600">Przypisany pracownik</th>
                                ...
                                {mockTasks.map((task) => (
                                    ...
                                    >
                                        <td className="p-3 text-gray-800 font-medium">{task.name}</td>
                    ...
                    <div className="bg-white/50 rounded-lg shadow p-6">
                        <h2 className="text-2xl font-semibold text-gray-800 mb-4">Przypisani pracownicy</h2>
                ...
                <div className="lg:col-span-1 space-y-6">
                    ...
                    <div className="bg-white/50 rounded-lg shadow p-6">
                        ...
                        <div className="space-y-2">
                            <Link href="#" className="text-blue-600 hover:underline block">Brief</Link>
                            <Link href="#" className="text-blue-600 hover:underline block">Dokumentacja</Link>
                        </div>
                        <p className="text-sm text-gray-500 mt-3">Pole do uzupełnienia</p>
                    </div>
                </div>
