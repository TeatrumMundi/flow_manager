...
export function TaskCompletionChart({ data }: { data: TaskData }) {
    ...
    const degCanceled = (data.canceled / total) * 360;
            ...
            <div className="flex-grow flex flex-col items-center justify-center">
                ...
                <div className="grid grid-cols-2 gap-x-4 gap-y-2 mt-6 w-full text-xs">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-sm" style={{ background: colors.todo }}></div>
                        <span className="text-gray-600">Do zrobienia</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-sm" style={{ background: colors.inProgress }}></div>
                        <span className="text-gray-600">W trakcie</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-sm" style={{ background: colors.inReview }}></div>
                        <span className="text-gray-600">W przeglądzie</span>
                    </div>

                    {/* Kolumna 2 */}
                    <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-sm" style={{ background: colors.done }}></div>
                        <span className="text-gray-600">Ukończone</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-sm" style={{ background: colors.blocked }}></div>
                        <span className="text-gray-600">Zablokowane</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <div className="w-3 h-3 rounded-sm" style={{ background: colors.canceled }}></div>
