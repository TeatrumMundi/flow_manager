import { pgTable, unique, serial, varchar, text, foreignKey, integer, timestamp, numeric, date, boolean } from "drizzle-orm/pg-core"
...
export const userCredentials = pgTable("user_credentials", {
	...
	passwordUpdatedAt: timestamp("password_updated_at", { mode: 'string' }).defaultNow(),
}, (table) => [
	foreignKey({
